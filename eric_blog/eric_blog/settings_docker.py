...
env = {
    'SECRET_KEY': os.environ.get('SECRET_KEY', 'I use eric'),
    'WEBSITE_TITLE': os.environ.get('WEBSITE_TITLE', u'eric'),
    'WEBSITE_WELCOME': os.environ.get('WEBSITE_WELCOME', u'欢迎来到eric'),
    ...
    'EMAIL_SUBJECT_PREFIX': os.environ.get('EMAIL_SUBJECT_PREFIX', u'eric'),
...
WSGI_APPLICATION = 'eric_blog.wsgi.application'
...
STATIC_ROOT = '/eric_blog/static/'

# 设置user model
AUTH_USER_MODEL = "eric_auth.ericUser"
...
EMAIL_HOST_PASSWORD = 'zjhan9901'              # 我的邮箱密码 例如  xxxxxxxxx
