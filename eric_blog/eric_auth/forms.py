...
class ericUserCreationForm(forms.ModelForm):
    ...
    def clean_username(self):
        ...
        try:
            ericUser._default_manager.get(username=username)
    ...
    def clean_email(self):
        ...
        # 判断是这个email 用户是否存在
        try:
            ericUser._default_manager.get(email=email)
        except ericUser.DoesNotExist:
            return email
        raise forms.ValidationError(
    ...
    def save(self, commit=True):
        user = super(ericUserCreationForm, self).save(commit=False)
...
class ericPasswordRestForm(forms.Form):
    ...
    def clean(self):
        ...
        if username and email:
            try:
                self.user = ericUser.objects.get(
