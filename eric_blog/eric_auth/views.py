...
from eric_auth.forms import ericUserCreationForm, ericPasswordRestForm
from eric_auth.models import ericUser
from eric_system.models import Notification
import time
import datetime
...
class UserControl(View):
    ...
    def register(self, request):
        ...
        form = ericUserCreationForm(request.POST)
    ...
    def forgetpassword(self, request):
        ...
        form = ericPasswordRestForm(request.POST)
    ...
    def resetpassword(self, request):
        ...
        try:
            ...
            user = ericUser._default_manager.get(pk=uid)
        except (TypeError, ValueError, OverflowError, ericUser.DoesNotExist):
            user = None
