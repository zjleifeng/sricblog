...
from eric_comments.models import Comment
...
class CommentControl(View):
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            article = ArticleModel.objects.get(id=en_id)
        except ArticleModel.DoesNotExist:
            logger.error(u'[CommentControl]此文章不存在:[%s]' % en_id)
        ...
        try:
            ...
            img = "http://eric.qiniudn.com/image/tx/tx-default.jpg"
